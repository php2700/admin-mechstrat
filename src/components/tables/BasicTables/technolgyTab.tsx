...
export default function Technology() {
        ...
        try {
            ...
            if (res.data?.data) {
                ...
                setPreview({
                    ...
                    businessGrowthImage1: `${import.meta.env.VITE_APP_URL}${d.businessGrowthImage1}`,
                    businessGrowthImage2: `${import.meta.env.VITE_APP_URL}${d.businessGrowthImage2}`,
                    businessGrowthImage3: `${import.meta.env.VITE_APP_URL}${d.businessGrowthImage3}`,
                });
            }
        } catch (err) {
            console.log(err);
    ...
    const handleSubmit = async () => {
        ...
        fd.append("challengeDescription", JSON.stringify(form.challengeDescription));
        ...
        Object.keys(form).forEach((key) => {
            if (!["marketStrategy", "partnershipStrategy", "challengeDescription"].includes(key)) {
    ...
    return (
        <div className="p-8 mx-auto bg-white shadow-lg rounded-xl space-y-8">
                ...
                {form.marketStrategy.map((item, i) => (
                    <div key={i} className="border p-4 rounded-lg mb-3">
                        ...
                        <textarea
                            ...
                            onChange={(e) =>
                                handleArrayChange(i, "description", e.target.value, "marketStrategy")
                            }
            ...
            <div className="grid grid-cols-3 gap-4">
                {["businessGrowthImage1", "businessGrowthImage2", "businessGrowthImage3"].map(
                    (field) => (
                        <div key={field}>
